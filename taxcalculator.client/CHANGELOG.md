...
- Create Angular project with ng: `ng new taxcalculator.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`taxcalculator.client.esproj`).
